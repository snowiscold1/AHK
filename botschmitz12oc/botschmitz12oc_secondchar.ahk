...
Gui,2: Show, NoActivate x538 y454,uptime  ; screen position here
...

{
				...
				jumpa = 1
				kill++
				ControlClick, x336 y306, %Title2%,, LEFT, 1, NA ; prepare for elite main char
				goto looting
}
...
looting:
sleep 7000
ControlClick, x370 y306, %Title2%,, LEFT, 1, NA ; 2nd slot
sleep 2000
ControlClick, x370 y306, %Title2%,, LEFT, 1, NA ; 2nd slot
sleep 1000
gosub ChainPlay
...
ChainPaused:
ControlClick, x59 y102, %Title2%,, LEFT, 1, NA ; status
sleep 500
...
inpost:
gosub openmap
ControlClick, x374 y85, %Title2%,, LEFT, 1, NA ;location spot upper right
sleep 1500
ControlClick, x374 y85, %Title2%,, LEFT, 1, NA ;location spot upper right
...
backtologin:
ControlClick, x23 y56, %Title2%,, LEFT, 1, NA ; back to login
sleep 60000
ControlClick, x270 y253, %Title2%,, LEFT, 1, NA ; press to start
sleep 10000
ControlClick, x270 y253, %Title2%,, LEFT, 1, NA ; press to start
sleep 10000
ControlClick, x39 y185, %Title2%,, LEFT, 1, NA ; choose char
sleep 5000
ControlClick, x39 y185, %Title2%,, LEFT, 1, NA ; choose char
sleep 220000
ControlClick, x465 y300, %Title2%,, LEFT, 1, NA ; start
sleep 15000
ControlClick, x413 y63, %Title2%,, LEFT, 1, NA ; closepopup
return
...
CoordMode,Mouse, Screen
MouseGetPos, hereX, hereY
random, randY, 482,489
Click, 952,%randY%, Down
sleep 300
MouseMove, 952,568,10
sleep 300
Click, 952,568,Up
MouseMove, %hereX%, %hereY%
sleep 500
